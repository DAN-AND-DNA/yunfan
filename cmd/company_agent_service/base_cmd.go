...
var (
	...
	base_cmd        = &cobra.Command{
		Use:   "company_agent_service [flags]",
		Short: "公司代理服务",
...
type Env_runtime struct {
	DB_sqlite_dsn         string `json:"db_sqlite_dsn"`
...
func Execute() {
	base_cmd.Flags().StringVarP(&(ptr_env_runtime.DB_sqlite_dsn), "db-sqlite-dsn", "", "file:company_agent_db?mode=memory&cache=shared&_auto_vacuum=incremental&_loc=auto", "sqlite的dsn")
...
Flags:
      ...
      --db-sqlite-dsn string                sqlite的dsn (default "file:company_agent_db?mode=memory&cache=shared&_auto_vacuum=incremental&_loc=auto")
  -h, --help                                help for company_agent_service
